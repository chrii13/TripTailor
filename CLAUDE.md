...
- **Primary Commands:**
  - **Dev:** `npm run dev`
  - **Build:** `npm run build`
  - **Test:** `npm test` (vitest, 299 tests across 31 test files; `.claude/**` è escluso in `vitest.config.ts`, il comando semplice basta)

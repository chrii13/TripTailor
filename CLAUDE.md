...
- **Primary Commands:**
  - **Dev:** `npm run dev`
  - **Build:** `npm run build`
  - **Test:** `npm test` (vitest, 343 tests across 33 test files; `.claude/**` è escluso in `vitest.config.ts`, il comando semplice basta)

...
export function SiteIdentity() {
  ...
  return (
    ...
    >
      ...
      >
        <p className="max-w-3xl font-display text-4xl leading-[1.15] font-[725] tracking-[-0.01em] text-balance text-voltage sm:text-6xl">
          Niente più tab aperte tra mappe, meteo e fogli di calcolo.
        </p>
        <p className="mt-12 max-w-xl text-primary-foreground/75 sm:text-lg">
